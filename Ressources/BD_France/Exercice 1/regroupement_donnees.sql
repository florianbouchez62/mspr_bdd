...
BEGIN
    ...
    FOR dmd IN unaffected_demande_lille
            LOOP
                INSERT INTO DEMANDE(NODEMANDE, DATEDEMANDE, DATEENLEVEMENT, SIRET)
                VALUES (SEQ_DEMANDE.nextval, dmd.DATEDEMANDE, dmd.DATEENLEVEMENT, dmd.SIRET);
            END LOOP;
    ...
    FOR dmd IN unaffected_demande_paris
        LOOP
            INSERT INTO DEMANDE(NODEMANDE, DATEDEMANDE, DATEENLEVEMENT, WEB_O_N, SIRET)
            VALUES (SEQ_DEMANDE.nextval, dmd.DATEDEMANDE, dmd.DATEENLEVEMENT, dmd.WEB_O_N, dmd.SIRET);
        END LOOP;
END;
-- < EMPLOYE && TOURNEE && DEMANDE && DETAILDEMANDE && DETAILDEPOT
